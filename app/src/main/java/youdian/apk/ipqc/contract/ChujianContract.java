 ...
 */
public interface ChujianContract {

    interface IMainModel {
        Observable<Response<ListResponseData<SEData>>> getSEData(String org_code);

        Observable<Response<ListResponseData<HomeTableData>>> getHomeTableData(String se_code);
    ...
    interface Presenter {
        ...
        void getTableList(String se_code, String flag);
