package youdian.apk.dianjian.utils
...
object DatetimeUtil {
 ...
 /**
     ...
     */
    val nows_s: String
        get() = formatDate(now, DATE_PATTERN);

 /**
     * 获取现在时刻
     */
    val nows_ss: String
        get() = formatDate(now, DATE_PATTERN_SS);

 /**
     * 获取现在时刻
     */
    val second_ss: String
        get() = formatDate(now, TIME_PATTERN_SS);
