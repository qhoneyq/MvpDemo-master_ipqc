...
public class DeviceUtil {
    ...
    private static final String COMMENUUID = "COMMENUUID";
    ...
    public static String getDeviceId(Context ctx) {
        ...
        File uuidFile = new File("/sdcard/" + COMMENUUID + "/uuid.txt");
        if (uuidFile.exists()) {
            uniqueId = FileUtils.getFileContent(uuidFile);
        } else {
            ...
            if (uniqueId == null) {
                ...
                FileUtils.writeTxtToFile(uniqueId, "/sdcard/" + COMMENUUID + "/", "uuid.txt");
                SPUtils.getInstance().save(UUID, uniqueId);
                return uniqueId;
            }
        }
        return uniqueId;
    ...
    public static String readDeviceId(Context ctx) {
        ...
        File uuidFile = new File("/sdcard/" + COMMENUUID + "/uuid.txt");
        if (!uuidFile.exists()) {
            uuid = getDeviceId(ctx);
        } else {
//            uuid = "ffffffff-b5f0-1b0b-0033-c5870033c587";
            uuid =  FileUtils.getFileContent(uuidFile);
//            SPUtils.getInstance().get(UUID,"");
        }
        return uuid;
    }
