...
public class CaptureManager {
    ...
    public void initializeFromIntent(Intent intent, Bundle savedInstanceState) {
        ...
        if (intent != null) {
            ...
            if (intent.hasExtra(Intents.Scan.BEEP_RESOURCE)) {
                beepManager.setBeepResource(intent.getIntExtra(Intents.Scan.BEEP_RESOURCE,-1));
            }

            if (intent.getBooleanExtra(Intents.Scan.VIBRATE_ENABLED, false)) {
